...
$content =
    "<div class=\"row text-center\"><span class=\"content\">" .
    _SELECTDATETYPE .
    "<br><br></span>";
$content .=
    "
    ...
    "includes/Ajax/jquery/select2.css\">
	<script src=\"" .
    $nuke_configs['nukecdnurl'] .
    "includes/Ajax/jquery/select2.min.js\" /></script>
    ...
    "index.php?datetype=0\" $sel0>" .
    _DEFAULT .
    "</option>
		<option value=\"" .
    $nuke_configs['nukeurl'] .
    "index.php?datetype=1\"  $sel1>" .
    _JALALI .
    "</option>
		<option value=\"" .
    $nuke_configs['nukeurl'] .
    "index.php?datetype=2\"  $sel2>" .
    _HIJRI .
    "</option>
		<option value=\"" .
    $nuke_configs['nukeurl'] .
    "index.php?datetype=3\"  $sel3>" .
    _JULIAN .
    "</option>
	</select>";
if (_DIRECTION == 'rtl') {
...
foreach ($all_languages as $language) {
    ...
    $content .=
        "<div class=\"col-xs-$cols_number\"><a href=\"" .
        $nuke_configs['nukeurl'] .
        "index.php?lang=$language\"><img src=\"" .
        $nuke_configs['nukeurl'] .
        "images/language/flag-$language.png\" border=\"0\" alt=\"$altlang\" title=\"$altlang\" height=\"16\" width=\"30\"></a></div>\n";
}
$content .= "<br>
	</span>
	</div>";
