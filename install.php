...
{
	global $db, $nuke_configs, $db_fields, $pn_dbtype, $pn_dbfetch, $pn_dbcharset, $cache;
...
{
	global $db, $nuke_configs, $install_fields, $pn_dbtype, $pn_dbfetch, $pn_dbcharset, $Req_URL, $cache;
...
function upgrade_final()
{
	...
	if($install_options['mode'] == 'install')
	{
		...
		$db->table(USERS_TABLE)
			->multiinsert(array('user_id', 'group_id', 'user_groups', 'user_status', 'username', 'user_realname', 'user_lastvisit', 'user_lastpage', 'user_regdate'),$users_data);
	}
