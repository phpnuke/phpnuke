...
$lang = array_merge($lang, array(
	...
	'MIGRATION_EXCEPTION_ERROR'			=> 'مشکل غیر منتظره ای در هنگام پرش بوجود آمده است. قبل از تغییرات خطایی بوجود آمده است, بایستی این خطا را در انجمن خود بیابید:<br><br>%s',
