	...
	function main($id, $mode)
	{
		...
		switch ($mode)
		{
			case 'settings':
				...
				{
					if (!is_array($optionvalue) && @is_bool($this->core->seo_opt[$optionvalue]))
					{
		...
		{
			if ((!isset($cfg_array[$config_name]) && isset($cfg_setup['method']) && @$cfg_setup['method'] != 'select_multiple') || strpos($config_name, 'legend') !== false)
			{
				continue;
			}
