...
$.fn.extend({
	...
	position: function(options, returnObject) {
		...
		if (browser[0] == 'mozilla') {
			do {
				...
				if (browser[0] == 'mozilla' && parent != elem && $.css(parent, 'overflow') != 'visible') {
	...
	offset: function(options, returnObject) {
		var x = 0, y = 0, sl = 0, st = 0,
		    ...
		    mo = ((browser[0] == 'mozilla') ? true:false), ie = ((browser[0] == 'msie') ? true:false), sf = ((browser[0] == 'safari') ? true:false), oa = ((browser[0] == 'opera') ? true:false),
...
var handleOffsetReturn = function(elem, options, x, y, sl, st) {
	...
	if ( options.border && (browser[0] == 'safari' || browser[0] == 'opera') ) {
		x += num(elem, 'borderLeftWidth');
		y += num(elem, 'borderTopWidth');
	} else if ( !options.border && !(browser[0] == 'safari' || browser[0] == 'opera') ) {
		x -= num(elem, 'borderLeftWidth');
		y -= num(elem, 'borderTopWidth');
	}
