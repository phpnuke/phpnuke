...
if (check_admin_permission($filename)) {
    ...
    function cache()
    {
        ...
        $contents .=
            "</table>
		<br /><br /><div align=\"center\"><a href=\"" .
            $admin_file .
            ".php?op=FlushCache&csrf_token=" .
            _PN_CSRF_TOKEN .
            "\"><b>" .
            _FLUSHALLCACHES .
            "</b></a></div>
		...
		<input type=\"hidden\" name=\"csrf_token\" value=\"" .
            _PN_CSRF_TOKEN .
            "\" /> 
		<br /><br /><input type=\"submit\" class=\"form-submit\" value=\"" .
            _SAVECHANGES .
            "\">	
		</form>";
    ...
    function updatecache($main_caches_inputs)
    {
        ...
        add_log(
            sprintf(_FLUSHCOSTUMCACHESLOG, implode(", ", $main_caches_inputs)),
            1
        );
        Header("Location: " . $admin_file . ".php?op=cache");
    }
    ...
    $main_caches_inputs = isset($main_caches_inputs) ? $main_caches_inputs : [];
