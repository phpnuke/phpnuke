...
if (check_admin_permission($filename, true)) {
    ...
    function displayadmins($user_id = 0)
    {
        ...
        $hooks->add_filter("set_page_title", function () {
            return ["displayadmins" => _AUTHORS_AND_ADMINS];
        });
        ...
        if (is_God()) {
            if ($user_id != 0) {
                $result = $db->query(
                    "SELECT " .
                        ...
                        " as username, " .
                        $users_system->user_fields['realname'] .
                        " as realname, " .
                        $users_system->user_fields['user_email'] .
                        " as user_email, " .
                        $users_system->user_fields['user_website'] .
                        " as user_website, " .
                        $users_system->user_fields['user_password'] .
                        " as user_password FROM " .
                ...
                $row = isset($result->results()[0])
                    ? $result->results()[0]
                    : ['', '', '', '', ''];

                list($uname, $rname, $remail, $rsite, $rupass) = array_values(
                    $row
                );
                $rphone = $rrule = "";
            } else {
			...
			<table align=\"center\" class=\"product-table\" width=\"100%\"><tr>
				<th class=\"table-header-repeat line-left\" style=\"text-align:center;width:100px;\"><a>" .
                _ADMIN_NAME .
                "</a></th>
				<th class=\"table-header-repeat line-left\" style=\"text-align:center;width:150px;\"><a>" .
                _NICKNAME .
                " , " .
                _PHONE .
                "</a></th>
				...
				<th class=\"table-header-repeat line-left\" style=\"text-align:center;width:70px;\"><a>" .
                _LANGUAGES .
                "</a></th>
				<th class=\"table-header-repeat line-left\" style=\"text-align:center;width:100px;\"><a>" .
                _OPERATION .
            ...
            if ($db->count() > 0) {
                foreach ($result as $row) {
                    ...
                    if ($radminsuper == 1) {
                        ...
                        $contents .=
                            "<ul class=\"rtl tagit ui-widget ui-widget-content ui-corner-all\" style=\"border:0;\">";
                        foreach (
                            $nuke_admins_menu_cacheData
                            as $amid => $nuke_admins_menu_info
                        ) {
                            ...
                            $main_admins = explode(
                                ",",
                                $nuke_admins_menu_info['admins']
                            );

                            if (
                                array_key_exists($atitle, $main_menus) &&
                                in_array($a_aid, $main_admins)
                            ) {
                                $contents .= "
                        ...
                        foreach (
                            ...
                            as $mid => $nuke_modules_info
                        ) {
                            $mtitle = filter(
                                $nuke_modules_info['title'],
                                "nohtml"
                            );
                            $lang_titles = filter(
                                $nuke_modules_info['lang_titles'],
                                "nohtml"
                            );
                            ...
                            $modules_admins = explode(
                                ",",
                                $nuke_modules_info['admins']
                            );
                    ...
                    $contents .=
                        "<td align=\"center\"><a class=\"table-icon icon-1 info-tooltip\" href=\"" .
                        $admin_file .
                        ".php?op=modifyadmin&amp;chng_aid=$a_aid\" title=\"" .
                        _EDIT_ADMIN .
                        "\"></a>";
                    if ($name == "God") {
                        $contents .=
                            "<img src=\"images/delete_x.gif\" alt=\"" .
                            _MAINACCOUNT .
                            "\" title=\"" .
                            _MAINACCOUNT .
                        ...
                        $contents .=
                            "<a class=\"table-icon icon-2 info-tooltip\" href=\"" .
                            $admin_file .
                            ".php?op=deladmin&amp;del_aid=$a_aid&csrf_token=" .
                            _PN_CSRF_TOKEN .
                            "\" title=\"" .
                            _DELETE_ADMIN .
                            "\"></a></td></tr>";
			...
			<script>
                ...
                $admin_file .
                ".php',
						{'op' : 'remove_permission', 'admin_id' : admin_id, 'amid' : amid, 'mid' : mid , 'type' : type , 'csrf_token' : '" .
                _PN_CSRF_TOKEN .
                "' },
						function(data)
						{
			...
			<br>
			<div class=\"text-center\"><font class=\"tiny\">" .
                _GODNOTDEL .
                "</font></div>";
            $contents .= "<br>";
            $contents .=
			...
			<form action=\"" .
				...
				<table border=\"0\" cellpadding=\"3\" cellspacing=\"3\" class=\"product-table no-border id-form\" width=\"100%\">
					<tr>
						<th width=\"130\"><b>نام نمایشی</th>
						<td><input type=\"text\" name=\"author_fields[add_realname]\" size=\"30\" maxlength=\"50\" class=\"inp-form\" value=\"$rname\"/> <font class=\"tiny\">" .
                _REQUIRED .
                "</font></td>
					</tr>
					<tr>
                ...
                _NICKNAME .
                "</th>
						<td><input type=\"text\" style=\"direction:ltr\" name=\"author_fields[add_aid]\" size=\"30\" maxlength=\"25\" class=\"inp-form-ltr\" value=\"$uname\" /> <font class=\"tiny\">" .
                _REQUIRED .
                "</font></td>
					</tr>
					<tr>
                ...
                _EMAIL .
                "</th>
						<td><input type=\"text\" style=\"direction:ltr\" name=\"author_fields[add_email]\" size=\"30\" maxlength=\"60\" class=\"inp-form-ltr\" value=\"$remail\" /> <font class=\"tiny\">" .
                _REQUIRED .
                "</font></td>
					</tr>
					<tr>
                ...
                _PHONE .
                "</th>
						<td><input type=\"text\" style=\"direction:ltr\" name=\"author_fields[add_phone]\" size=\"30\" maxlength=\"60\" class=\"inp-form-ltr\" value=\"$rphone\" /> <font class=\"tiny\">" .
                _REQUIRED .
                "</font></td>
					</tr>
					<tr>
                ...
                "</th>
						<td>";
            $contents .= wysiwyg_textarea(
                'author_fields[add_rule]',
                $rrule,
                'Basic',
                10,
                5,
            ...
            if ($nuke_configs['multilingual'] == 1) {
                ...
                $contents .=
                    "<input type=\"hidden\" name=\"author_fields[add_admlanguage]\" value=\"\">";
            }
            $contents .=
                "
					<tr><th>" .
            ...
            foreach (
                ...
                if (array_key_exists($atitle, $main_menus)) {
                    ...
                    $contents .=
                        "\t<td width=\"25%\">&nbsp;<input type=\"checkbox\" data-label=\"$atitle2\" class=\"styled\" name=\"author_fields[auth_main_admins][]\" value=\"" .
                        intval($amid) .
                        "\" id=\"auth_main_admins_" .
                        intval($amid) .
                        "\"></td>\n";
                    if ($i == 4) {
                        $contents .= "</tr>\n";
            ...
            foreach (
                $nuke_modules_cacheData
                as $nuke_modules_key => $nuke_modules_info
            ) {
                ...
                $lang_titles =
                    $nuke_modules_info['lang_titles'] != ""
                        ? phpnuke_unserialize(
                            stripslashes($nuke_modules_info['lang_titles'])
                        )
                        : "";
                ...
                if (
                    ...
                    $contents .=
                        "<td width=\"25%\">&nbsp;<input data-label=\"$lang_title\" type=\"checkbox\" class=\"styled\" name=\"author_fields[auth_modules][]\" value=\"" .
                        intval($nuke_modules_key) .
                        "\" id=\"auth_modules_" .
                        intval($nuke_modules_key) .
                        "\"></td>";
                    if ($i == 4) {
            ...
            $contents .=
                "
					<tr>
						<td colspan=\"2\"><input data-label=\"<b>" .
                _SUPER_ADMIN .
                "</b>\" type=\"checkbox\" class=\"styled\" name=\"author_fields[add_radminsuper]\" id=\"add_radminsuper\" value=\"1\"></td>
					</tr>
					<tr>
						<td colspan=\"2\"><font class=\"tiny\"><i>" .
                _SUPERWARNING .
                "</i></font></td>
					</tr>
					<tr>
                ...
                _PASSWORD .
                "</td>
						<td><input type=\"password\" name=\"author_fields[add_pwd]\" size=\"12\" maxlength=\"40\" class=\"inp-form\" value=\"$rupass\" /> <font class=\"tiny\">" .
                _REQUIRED .
                "</font></td>
					</tr>
            ...
            $contents .=
                "<div class=\"text-center\"><font class=\"title\"><b>Authors Admin</b></font></div>";
            $contents .= "<br>";
            $contents .=
                "<div class=\"text-center\"><b>Not Authorized</b><br><br>" .
    ...
    function modifyadmin($chng_aid)
    {
        ...
        $hooks->add_filter("set_page_title", function () use ($chng_aid) {
            return ["modifyadmin" => _EDIT_ADMIN . " : $chng_aid"];
        });
        ...
        if (is_God()) {
            ...
            $chng_name = filter(
                $nuke_authors_cacheData[$adm_aid]['name'],
                "nohtml"
            );
            $chng_realname = filter(
                $nuke_authors_cacheData[$adm_aid]['realname'],
                "nohtml"
            );
            $chng_url = filter(
                $nuke_authors_cacheData[$adm_aid]['url'],
                "nohtml"
            );
            $chng_email = filter(
                $nuke_authors_cacheData[$adm_aid]['email'],
                "nohtml"
            );
            $chng_pwd = filter(
                $nuke_authors_cacheData[$adm_aid]['pwd'],
                "nohtml"
            );
            $chng_phone = filter(
                $nuke_authors_cacheData[$adm_aid]['phone'],
                "nohtml"
            );
            $chng_rule = stripslashes(
                $nuke_authors_cacheData[$adm_aid]['rule']
            );
            $chng_radminsuper = intval(
                $nuke_authors_cacheData[$adm_aid]['radminsuper']
            );
            $chng_admlanguage =
                $nuke_authors_cacheData[$adm_aid]['admlanguage'];
			...
			<form action=\"" .
                ...
                _NICKNAME .
                "</th>
						<td><input type=\"text\" name=\"author_fields[chng_realname]\" value=\"$chng_realname\" class=\"inp-form\"> <font class=\"tiny\">" .
                _REQUIRED .
                "</font></td>
					</tr>
					<tr>
                ...
                _USERNAME .
                "</th>
						<td><input type=\"text\" name=\"author_fields[chng_aid]\" value=\"$adm_aid\" size=\"30\" maxlength=\"25\" class=\"inp-form-ltr\"> <font class=\"tiny\">" .
                _REQUIRED .
                "</font></td>
					</tr>
					<tr>
                ...
                _EMAIL .
                "</th>
						<td><input type=\"text\" name=\"author_fields[chng_email]\" value=\"$chng_email\" size=\"30\" maxlength=\"60\" class=\"inp-form-ltr\"> <font class=\"tiny\">" .
                _REQUIRED .
                "</font></td>
					</tr>
					<tr>
                ...
                _PHONE .
                "</th>
						<td><input type=\"text\" style=\"direction:ltr\" name=\"author_fields[chng_phone]\" size=\"30\" maxlength=\"60\" class=\"inp-form-ltr\" value=\"$chng_phone\" /> <font class=\"tiny\">" .
                _REQUIRED .
                "</font></td>
					</tr>
					<tr>
            ...
            if ($nuke_configs['multilingual'] == 1) {
                ...
                foreach ($languageslist as $language_name) {
                    ...
                    $contents .=
                        "<option value=\"$language_name\"" .
                        ($language_name == $chng_admlanguage
                            ? "selected"
                            : "") .
                        ">" .
                        ucfirst($language_name) .
                ...
                $contents .=
                    "<input type=\"hidden\" name=\"author_fields[chng_admlanguage]\" value=\"\">";
            }
            ...
            if ($nuke_authors_cacheData[$adm_aid]['name'] != "God") {
                ...
                foreach (
                    $nuke_admins_menu_cacheData
                    as $nuke_admins_menu => $nuke_admins_menu_info
                ) {
                    //$atitle = @ereg_replace("_", " ", $nuke_admins_menu_info['atitle']);
                    $atitle = $nuke_admins_menu_info['atitle'];
                    $atitle2 = get_title_lang_name($atitle);
                    ...
                    if (array_key_exists($atitle, $main_menus)) {
                        ...
                        $checked = in_array($adm_aid, $main_admins)
                            ? "checked"
                            : "";

                        $contents .=
                            "\t<td width=\"25%\">&nbsp;<input data-label=\"$atitle2\" type=\"checkbox\" class=\"styled\" name=\"author_fields[auth_main_admins][]\" value=\"" .
                            intval($nuke_admins_menu) .
                            "\" $checked></td>\n";
                        if ($i == 4) {
                            $contents .= "</tr>\n";
                            $i = 0;
                ...
                foreach (
                    ...
                    if (
                        ...
                        $checked = in_array($adm_aid, $modules_admins)
                            ? "checked"
                            : "";
                ...
                $contents .=
                    "<tr><td>&nbsp;</td><td><input data-label=\"<b>" .
                    _SUPER_ADMIN .
                    "</b>\" type=\"checkbox\" class=\"styled\" name=\"author_fields[chng_radminsuper]\" value=\"1\" $sel1> </td></tr>";
                $contents .=
                    "<tr><td>&nbsp;</td><td><font class=\"tiny\"><i>" .
                    _SUPERWARNING .
                    "</i></font></td></tr>";
            }
            ...
            $contents .=
                ...
                _RETYPEPASSWD .
                ":</th>
						<td><input type=\"password\" name=\"author_fields[chng_pwd2]\" size=\"12\" maxlength=\"40\" class=\"inp-form\"> <font class=\"tiny\">" .
                _FORCHANGES .
                "</font></td>
					</tr>
					<tr>
        ...
        if (is_God()) {
            ...
            if ($adm_aid != $chng_aid) {
                $db->query(
                    "update " .
                        POSTS_TABLE .
                        " set aid=?, informant = IF(informant = ?, ?, informant) where aid = ?",
                    [$chng_aid, $adm_aid, $chng_aid, $adm_aid]
                );
            }
            $sql_qrray['radminsuper'] =
                is_God($adm_aid) && $chng_name == 'God' ? 1 : 0;
            ...
            $aadminsuper =
                isset($auth_main_admins) && sizeof($auth_main_admins) > 0
                    ? 1
                    : 0;
            ...
            if (
                isset($auth_modules) &&
                is_array($auth_modules) &&
                !empty($auth_modules)
            ) {
                foreach (
                    $nuke_modules_cacheData
                    as $nuke_modules_mid => $nuke_modules_info
                ) {
                ...
                foreach ($auth_modules as $auth_module) {
                    if ($nuke_modules_cacheData[$auth_module]['admins'] != "") {
                        $admins = explode(
                            ",",
                            $nuke_modules_cacheData[$auth_module]['admins']
                        );
                        if (!in_array($chng_aid, $admins)) {
                            $admins[] = $chng_aid;
                        }
            ...
            if (
                isset($auth_main_admins) &&
                is_array($auth_main_admins) &&
                !empty($auth_main_admins)
            ) {
                foreach (
                    $nuke_admins_menu_cacheData
                    as $nuke_admins_menu_key => $nuke_admins_menu_info
                ) {
                ...
                foreach ($auth_main_admins as $auth_main_admin) {
                    if (
                        $nuke_admins_menu_cacheData[$auth_main_admin][
                            'admins'
                        ] != ""
                    ) {
                        $admins = explode(
    ...
    function addauthor($author_fields)
    {
        ...
        $hooks->add_filter("set_page_title", function () use ($add_aid) {
            return ["addauthor" => _ADD_ADMIN . " : $add_aid"];
        });
        ...
        if (
            isset($nuke_admins_menu_cacheData[$add_aid]) &&
            !empty($nuke_admins_menu_cacheData[$add_aid])
        ) {
            $contents .= GraphicAdmin();
            $contents .=
                "<div class=\"text-center\"><font class=\"option\"><b>" .
        ...
        if (!isset($user_id) || $user_id <= 1) {
            $add_pwd = phpnuke_hash_password($add_pwd);
        }
        ...
        if (
            ...
            foreach ($auth_main_admins as $auth_main_admin) {
                if (
                    $nuke_admins_menu_cacheData[$auth_main_admin]['admins'] !=
                    ""
                ) {
                    $admins = explode(
                        ",",
        ...
        $db->table(AUTHORS_TABLE)->insert([
            ...
            'pwd' => $add_pwd,
            'radminsuper' =>
                isset($add_radminsuper) && $add_radminsuper == 1 ? 1 : 0,
    ...
    function remove_permission($admin_id, $amid, $mid, $type)
    {
        ...
        $cache_data =
            $type == 'admin'
                ? $nuke_admins_menu_cacheData[$amid]
                : $nuke_modules_cacheData[$mid];
        ...
        $menu_title =
            $type == 'admin'
                ? $nuke_admins_menu_cacheData[$amid]['atitle']
                : $nuke_modules_cacheData[$mid]['title'];
        ...
        if (
            $db->query(
                "UPDATE " . $table . " SET admins = ? WHERE $tvar  = ?",
                [$main_admins, $tval]
            )
        ) {
            add_log(
                sprintf(_REMOVE_ADMIN_PERMISSIONS, $admin_id, $menu_title),
                1
            );
    ...
    function deladmin($del_aid)
    {
        ...
        $hooks->add_filter("set_page_title", function () use ($del_aid) {
            return ["addauthor" => _DELETE_ADMIN . " : $del_aid"];
        });
        ...
        $contents .=
            "[ <a href=\"" .
            $admin_file .
            ".php?op=deladmin2&amp;del_aid=$del_aid&csrf_token=" .
            _PN_CSRF_TOKEN .
            "\">" .
            _YES .
            "</a> | <a href=\"" .
    ...
    function deladmin2($del_aid)
    {
        ...
        if (is_God()) {
            ...
            if ($articles_admins != "") {
                ...
                if (
                    in_array(
                        $nuke_authors_cacheData[$del_aid]['name'],
                        $articles_admins
                    )
                ) {
                    $radminarticle = 1;
            ...
            if ($radminarticle == 1) {
                ...
                if ($aid_articles > 0) {
                    ...
                    $contents .=
                        "<form action=\"" .
                        $admin_file .
                        ".php\" method=\"post\"><select name=\"newaid\" class=\"styledselect-select\">";
                    foreach (
                        $nuke_authors_cacheData
                        as $nuke_authors_aid => $nuke_authors_info
                    ) {
                    ...
                    $contents .=
                        "</select><input type=\"hidden\" name=\"del_aid\" value=\"$del_aid\">" .
                        "<input type=\"hidden\" name=\"op\" value=\"assignarticles\"><input type=\"hidden\" name=\"csrf_token\" value=\"" .
                        _PN_CSRF_TOKEN .
                        "\" /> " .
            ...
            Header(
                "Location: " .
                    $admin_file .
                    ".php?op=deladminconf&del_aid=$del_aid&csrf_token=" .
                    _PN_CSRF_TOKEN .
                    ""
            );
        } else {
    ...
    function assignarticles($del_aid, $newaid)
    {
        ...
        $db->query(
            "update " .
                AUTHORS_TABLE .
                " set counter=counter+$numrows where aid=?",
            [$newaid]
        );
    ...
    $chng_radminsuper = isset($chng_radminsuper)
        ? intval($chng_radminsuper)
        : 0;
    $auth_modules = isset($auth_modules) ? $auth_modules : [];
    $author_fields = isset($author_fields) ? $author_fields : [];
