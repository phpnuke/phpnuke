...
if (check_admin_permission($filename)) {
    function upgrade($start_upgrade)
    {
        ...
        if (
            $latest_version != '' &&
            version_compare($Version_Num, "$latest_version", "<")
        ) {
        ...
        if (!$start_upgrade) {
			...
			<div align=\"center\">
				<table class=\"product-table\" border=\"1\" width=\"600\">
					...
					<tr>
						<td style=\"width:50%;line-height:25px;\">" .
                _YOUR_NUKE_VERSION .
                "</td>
					...
					<tr>
						<td style=\"width:50%;line-height:25px;\">" .
                _LATEST_NUKE_VERSION_PUBLISHED .
                "</td>
						<td style=\"width:50%;line-height:25px;\">" .
                $latest_version .
                "</td>
            ...
            if (!$version_check) {
                ...
                $contents .=
                    ...
                    "" .
                    $admin_file .
                    ".php?op=upgrade&start_upgrade=true&csrf_token=" .
                    _PN_CSRF_TOKEN .
                    "\" />
							</form>
							</td>
    ...
    $start_upgrade = isset($start_upgrade)
        ? filter($start_upgrade, "nohtml")
        : '';
