...
if (check_admin_permission($filename)) {
    function modules()
    {
        ...
        $contents .=
            "<div class=\"text-center\"><font class='option'>" .
            _MODULES .
            "</font><br><br>";
        $contents .=
        ...
        foreach ($nuke_modules_cacheData as $mid => $module_info) {
            ...
            $lang_titles =
                $module_info['lang_titles'] != ""
                    ? phpnuke_unserialize(
                        stripslashes($module_info['lang_titles'])
                    )
                    : "";
            ...
            $mod_permissions =
                $module_info['mod_permissions'] != ""
                    ? explode(",", $module_info['mod_permissions'])
                    : '';
            ...
            if ($module_info['main_module'] == 1) {
                ...
                $puthome =
                    "<a href='" .
                    $admin_file .
                    ".php?op=home_module&mid=$mid&csrf_token=" .
                    _PN_CSRF_TOKEN .
                    "' onclick=\"retirn confirm('" .
                    _SURETOCHANGEMOD .
                    "');\">" .
                    _PUTINHOME .
                    "</a>";
                $change_status =
                    "<a href='" .
                    $admin_file .
                    ".php?op=module_status&mid=$mid&active=$act&csrf_token=" .
                    _PN_CSRF_TOKEN .
                    "'>$change</a>";
            }
			...
			<td align='center'>[ <a href='" .
                $admin_file .
                ".php?op=module_edit&mid=$mid'>" .
                _EDIT .
                "</a> | $change_status | $puthome ]</td>
			</tr>";
            $i++;
        }
        ...
        $contents .=
            "<tr>
		<td align='center' colspan=\"6\"><font class='title'><b>" .
            _INVISIBLEMODULES .
            "</b></font></td></tr>";
        $i = 0;
        foreach ($nuke_modules_cacheData as $mid => $module_info) {
    ...
    function module_status($mid, $active)
    {
        ...
        add_log(
            sprintf(
                _ACTIVATEMODULELOG,
                $active == 1 ? _ACTIVATE : _DEACTIVATE,
                $result['title']
            ),
            1
        );
    ...
    function module_edit($mid, $submit = '', $module_data = [])
    {
        ...
        if (
            isset($submit) &&
            $submit != '' &&
            is_array($module_data) &&
            !empty($module_data)
        ) {
            $mod_permissions =
                is_array($module_data['mod_permissions']) &&
                !empty($module_data['mod_permissions'])
                    ? implode(",", $module_data['mod_permissions'])
                    : "";
            ...
            if ($nuke_configs['multilingual'] == 1) {
                $lang_titles = !empty($module_data['lang_titles'])
                    ? phpnuke_serialize($module_data['lang_titles'])
                    : "";
            } else {
        ...
        $pagetitle =
            _MODULES_ADMIN .
            " - " .
            sprintf(_EDITMODULETATA, $modules_row['title']);
        $hooks->add_filter("set_page_title", function () use ($pagetitle) {
            return ["module_edit" => $pagetitle];
        });
        ...
        $lang_titles =
            $modules_row['lang_titles'] != ""
                ? phpnuke_unserialize(stripslashes($modules_row['lang_titles']))
                : [];
        $mod_permissions =
            $modules_row['mod_permissions'] != ""
                ? explode(",", $modules_row['mod_permissions'])
                : [];

        $nuke_modules_boxes_parts = [];
        $module_parts_list = [];

        $nuke_modules_boxes_parts = $hooks->apply_filters(
            "modules_boxes_parts",
            $nuke_modules_boxes_parts
        );

        if (
            isset($nuke_modules_boxes_parts[$modules_row['title']]) &&
            is_array($nuke_modules_boxes_parts[$modules_row['title']]) &&
            !empty($nuke_modules_boxes_parts[$modules_row['title']])
        ) {
            foreach (
                $nuke_modules_boxes_parts[$modules_row['title']]
                as $module_part => $module_part_title
            ) {
                $module_part_title = defined($module_part_title)
                    ? constant($module_part_title)
                    : $module_part_title;
                $module_parts_list[] =
                    "<a href=\"" .
                    $admin_file .
                    ".php?op=module_edit_boxess&mid=$mid&module_part=$module_part\">$module_part_title</a>";
            }
        }
		...
		<tr><th align='center' colspan='2' class='option' style=\"text-align:center\"><b>" .
            _MODULES_EDIT .
            "</b><br>(" .
            $modules_row['title'] .
            "$a)</th></tr>";
        ...
        if ($nuke_configs['multilingual'] != 1) {
            $contents .=
                "<tr><th style=\"width:210px;\">" .
                _TITLE .
                ":</th><td><input class=\"inp-form\" type=\"text\" name=\"module_data[lang_titles]\" size=\"30\" maxlength=\"60\" value=\"" .
                $modules_row['lang_titles'] .
                "\"></td></tr>";
        } else {
            ...
            foreach ($languageslists as $languageslist) {
                if ($languageslist != "") {
                    ...
                    $contents .=
                        ...
                        "</th><td> ";
                    $contents .=
                        "<input class=\"inp-form\" type=\"text\" name=\"module_data[lang_titles][$languageslist]\" size=\"30\" maxlength=\"60\" style=\"margin-bottom:5px;\" value=\"" .
        ...
        $contents .=
            ...
            _SHOWINMENU .
            "</th><td><select name='module_data[in_menu]' class=\"styledselect-select\">
		<option value='1' $insel1> " .
            _YES .
            "</option><option value='0' $insel2> " .
            _NO .
            "</option>
		</select></td></tr>
		<tr><th>" .
        ...
        if ($modules_row['main_module'] == 1) {
            $contents .=
                "<input type='hidden' name='module_data[all_blocks]' value='1'>";
            $contents .=
                "<input type='hidden' name='module_data[activemodule]' value='1'>";
        } else {
            ...
            $contents .=
                "<input data-label=\"" .
                _YES .
                "\" type=\"radio\" class=\"styled\" name=\"module_data[all_blocks]\" value=\"1\" $sel2 />
		<input data-label=\"" .
                _NO .
                "\" type=\"radio\" class=\"styled\" name=\"module_data[all_blocks]\" value=\"0\" $sel1 />
		</td></tr>
		<tr><th>" .
                _ACTIVATE .
                "</th><td>";
            ...
            $contents .=
                "<input data-label=\"" .
                _YES .
                "\" type=\"radio\" class=\"styled\" name=\"module_data[activemodule]\" value=\"1\" $sel2 />
		<input data-label=\"" .
                _NO .
                "\" type=\"radio\" class=\"styled\" name=\"module_data[activemodule]\" value=\"0\" $sel1 />
		</td></tr>";
        }
        $contents .=
            "<tr><td align='center' colspan='2'><input type='submit' name='submit' value='submit' class=\"form-submit\"></td></tr>
		</table>
    ...
    function module_edit_boxess(
        ...
        $all_module_boxes =
            $all_module_boxes != ''
                ? phpnuke_unserialize(stripslashes($all_module_boxes))
                : [];
        $module_part =
            isset($module_part) && $module_part != '' ? $module_part : "index";
            ...
            if ($special_page != '') {
                ...
                if ($mresult->count() > 0) {
                    $db->table(POSTS_META_TABLE)
                        ...
                        ->where('meta_key', $special_page_arr[0])
                        ->update([
                            'meta_value' => phpnuke_serialize(
                                $all_module_boxes
                            ),
                        ]);
                } else {
                    $db->table(POSTS_META_TABLE)->insert([
        ...
        $nuke_modules_boxes_cacheData = get_cache_file_contents(
            'nuke_modules_boxes'
        );
        ...
        $pagetitle =
            _MODULES_ADMIN .
            " - " .
            sprintf(_EDITMODULEBOXESLAYOUTS, $modules_row['title']);
        $hooks->add_filter("set_page_title", function () use ($pagetitle) {
            return ["module_edit_boxess" => $pagetitle];
        });

        $module_boxes_def = isset($all_module_boxes[$module_part])
            ? $all_module_boxes[$module_part]
            : '';

        $all_module_boxes = isset($all_module_boxes[$module_part])
            ? explode("|", $all_module_boxes[$module_part])
            : [];
        $all_boxes = [];
        ...
        $contents .=
            ...
            ".php' method='post'>
		<table align='center' border='0' cellpadding='2' width=\"100%\" cellspacing='2' class=\"id-form product-table no-border\">
		<tr><th align='center' class='option' style=\"text-align:center\"><b>" .
            _CHANGEMODEDIT .
            "</b><br>(" .
            $modules_row['title'] .
            " - " .
            _PART .
            " $module_part)<br /><br /><a href=\"" .
            $admin_file .
            ".php?op=module_edit&mid=$mid\">" .
            _BACKTOMODULEEDITPAGE .
            "</a></th></tr>";
        //////////////////////
        ...
        if (
            isset($nuke_blocks_cacheData['blocks_boxes']) &&
            !empty($nuke_blocks_cacheData['blocks_boxes'])
        ) {
            foreach (
                $nuke_blocks_cacheData['blocks_boxes']
                as $box_id => $box_id_info
            ) {
                if (in_array($box_id, $all_boxes)) {
                    continue;
                }
        ...
        $contents .=
            "<li class=\"blocks-sortable-item ui-state-disabled\" id=\"main-module_content\"><span class=\"block-title\">" .
            _MAIN_MODULE_CONTENTS .
            "</span>
									</li>";
    ...
    $mod_permissions = isset($mod_permissions) ? $mod_permissions : [];
    $lang_titles = isset($lang_titles) ? $lang_titles : [];
    $module_data = isset($module_data) ? $module_data : [];
