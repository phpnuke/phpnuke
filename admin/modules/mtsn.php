...
if (check_admin_permission($filename)) {
    function mtsn_admin()
    {
        ...
        $hooks->add_filter("set_page_title", function () {
            return ["mtsn_admin" => _MTSNADMIN];
        });
        $contents = '';
        $contents .= GraphicAdmin();
        $contents .= OpenAdminTable();
        $contents .=
            "<div class=\"text-center\"><b>MTSN V " .
            $nuke_configs['mtsn_version'] .
            "</b></div>
		<br /><p align='center'>
		[ <a href='" .
            $admin_file .
		...
		<th style=\"width:200px;\">" .
            _SAVE_IN_TEXT_FILE .
            "</th>
		<td><input type=\"radio\" name=\"config_fields[mtsn_text_file]\" class=\"styled\" data-label=\"" .
            _YES .
            "\" value=\"1\" $check1 /> &nbsp;&nbsp; <input type=\"radio\" name=\"config_fields[mtsn_text_file]\" class=\"styled\" data-label=\"" .
            _NO .
            "\" value=\"0\" $check2 /></td></tr>";
        ...
        $contents .=
            "<tr><th>" .
            _SHOW_ATACK_WARNING .
            "</th><td><input type=\"radio\" name=\"config_fields[mtsn_show_alarm]\" class=\"styled\" data-label=\"" .
            _YES .
            "\" value=\"1\" $check1 /> &nbsp;&nbsp; <input type=\"radio\" name=\"config_fields[mtsn_show_alarm]\" class=\"styled\" data-label=\"" .
            _NO .
            "\" value=\"0\" $check2 /></td></tr>";
        ...
        $contents .=
            "<tr><th>" .
            _STATUS .
            "</th><td><input type=\"radio\" name=\"config_fields[mtsn_status]\" class=\"styled\" data-label=\"" .
            _ACTIVE .
            "\" value=\"1\" $check1 /> &nbsp;&nbsp; <input type=\"radio\" name=\"config_fields[mtsn_status]\" class=\"styled\" data-label=\"" .
            _INACTIVE .
            "\" value=\"0\" $check2 /></td></tr>";
        ...
        $contents .=
            "<tr><th>" .
            _AUTOMATIC_IPBAN .
            "</th><td><input type=\"radio\" name=\"config_fields[mtsn_block_ip]\" class=\"styled\" data-label=\"" .
            _ACTIVE .
            "\" value=\"1\" $check1 /> &nbsp;&nbsp; <input type=\"radio\" name=\"config_fields[mtsn_block_ip]\" class=\"styled\" data-label=\"" .
            _INACTIVE .
            "\" value=\"0\" $check2 /></td></tr>
		
		<tr><th>" .
            _UNBAN_AFTER .
            " </th><td><input type=\"text\" class=\"inp-form\" dir='ltr' name='config_fields[mtsn_block_ip_expire]' value='" .
            $nuke_configs['mtsn_block_ip_expire'] .
            "' size='30'> " .
            _SECOND .
            "" .
            bubble_show(_NUMBER_IS_SECOND) .
            "</td></tr>";
        ...
        $contents .=
            "<tr><th>" .
            _EMAIL_SENDING .
            "</th><td><input type=\"radio\" name=\"config_fields[mtsn_send_mail]\" class=\"styled\" data-label=\"" .
            _YES .
            "\" value=\"1\" $check1 /> &nbsp;&nbsp; <input type=\"radio\" name=\"config_fields[mtsn_send_mail]\" class=\"styled\" data-label=\"" .
            _NO .
            "\" value=\"0\" $check2 /></td></tr>
		
		<tr><th>" .
            _ADMINEMAIL .
            "</th><td><input type=\"text\" class=\"inp-form\" dir='ltr' name='config_fields[mtsn_admin_mail]' value='" .
            $nuke_configs['mtsn_admin_mail'] .
            "' size='30'></td></tr>
		<tr><th colspan=\"2\" style=\"text-align:center;\">" .
            _PROTECTION_AGAINST_ATTACKSSETTINGS .
            "</th></tr>";
		...
		<th>" .
            _STRINGS_ATTACKS .
            "</th>
		<td><input type=\"radio\" name=\"config_fields[mtsn_string_filter]\" class=\"styled\" data-label=\"" .
            _YES .
            "\" value=\"1\" $check1 /> &nbsp;&nbsp; <input type=\"radio\" name=\"config_fields[mtsn_string_filter]\" class=\"styled\" data-label=\"" .
            _NO .
            "\" value=\"0\" $check2 /></td>
		</tr>";
		...
		<tr>
		<th>" .
            _FILTERING_UNAUTHORIZED_CODES .
            "</th>
		<td><input type=\"radio\" name=\"config_fields[mtsn_html_filter]\" class=\"styled\" data-label=\"" .
            _YES .
            "\" value=\"1\" $check1 /> &nbsp;&nbsp; <input type=\"radio\" name=\"config_fields[mtsn_html_filter]\" class=\"styled\" data-label=\"" .
            _NO .
            "\" value=\"0\" $check2 /></td>
		</tr>";

        $check1 =
            $nuke_configs['mtsn_injection_filter'] == "1" ? " checked" : "";
        $check2 =
            $nuke_configs['mtsn_injection_filter'] == "0" ? " checked" : "";

        $contents .=
            "
		<tr>
		<th>" .
            _ATTACKS_TO_DATABASE .
            "</th>
		<td><input type=\"radio\" name=\"config_fields[mtsn_injection_filter]\" class=\"styled\" data-label=\"" .
            _YES .
            "\" value=\"1\" $check1 /> &nbsp;&nbsp; <input type=\"radio\" name=\"config_fields[mtsn_injection_filter]\" class=\"styled\" data-label=\"" .
            _NO .
            "\" value=\"0\" $check2 /></td>
		</tr>";
		...
		<th>" .
            _ATTACKS_TO_DDOS .
            "</th>
		<td><input type=\"radio\" name=\"config_fields[mtsn_ddos_filter]\" class=\"styled\" data-label=\"" .
            _YES .
            "\" value=\"1\" $check1 /> &nbsp;&nbsp; <input type=\"radio\" name=\"config_fields[mtsn_ddos_filter]\" class=\"styled\" data-label=\"" .
            _NO .
            "\" value=\"0\" $check2 />" .
            bubble_show(_ATTACKS_TO_DDOS_DESC) .
            "</td>
		</tr>
		<tr><th colspan=\"2\" style=\"text-align:center;\">" .
            _OTHER_SETTINGS .
        ...
        $mtsn_gfx_chk =
            $nuke_configs['mtsn_gfx_chk'] != ''
                ? (is_array($nuke_configs['mtsn_gfx_chk'])
                    ? $nuke_configs['mtsn_gfx_chk']
		...
		<tr>
            ...
            "</th><td>
				<table width=\"100%\">
					<tr>
						<td>
							<input type=\"checkbox\" class=\"styled\" name=\"config_fields[mtsn_gfx_chk][]\" value=\"admin_login\" data-label=\"" .
            _ADMIN_LOGIN .
            "\" $check1 /> &nbsp;&nbsp;
						</td>
						<td>
							<input type=\"checkbox\" class=\"styled\" name=\"config_fields[mtsn_gfx_chk][]\" value=\"user_login\" data-label=\"" .
            _ADMIN_LOGIN .
            "\" $check2 /> &nbsp;&nbsp;
						</td>
						<td>
							<input type=\"checkbox\" class=\"styled\" name=\"config_fields[mtsn_gfx_chk][]\" value=\"comments\" data-label=\"" .
            _COMMENT_SEND .
            "\" $check3 /> &nbsp;&nbsp;
						</td>
						<td>
							<input type=\"checkbox\" class=\"styled\" name=\"config_fields[mtsn_gfx_chk][]\" value=\"send_post\" data-label=\"" .
            _SEND_POST .
            "\" $check4 /> &nbsp;&nbsp;
						</td>
						<td>
							<input type=\"checkbox\" class=\"styled\" name=\"config_fields[mtsn_gfx_chk][]\" value=\"feedback\" data-label=\"" .
            _SEND_FEEDBACK .
            "\" $check5 /> &nbsp;&nbsp;
						</td>
					</tr>
					<tr>
						<td>
							<input type=\"checkbox\" class=\"styled\" name=\"config_fields[mtsn_gfx_chk][]\" value=\"user_sign_up\" data-label=\"" .
            _SIGNUP_COMPLATE .
            "\" $check6 /> &nbsp;&nbsp;
						</td>
					</tr>
		...
		<tr>
			<th>" .
            _GOOGLE_RECAPTCHA_API_SITEKEY .
            "</th>
			<td>
				<input type=\"text\" class=\"inp-form-ltr\" name=\"config_fields[google_recaptcha_sitekey]\" value=\"" .
		...
		<tr>
			<th>" .
            _GOOGLE_RECAPTCHA_API_SECRETKEY .
            "</th>
			<td>
				<input type=\"text\" class=\"inp-form-ltr\" name=\"config_fields[google_recaptcha_secretkey]\" value=\"" .
		...
		<tr>
            ...
            "</th>
			<td>
				<input type=\"text\" class=\"inp-form\" name=\"config_fields[mtsn_captcha_charset]\" value=\"" .
            $nuke_configs['mtsn_captcha_charset'] .
            "\" />
			" .
		...
		<tr>
			<th>" .
            _DISALLOWED_WORD_AND_CHARS .
            "</th>
			<td>
				<textarea class=\"form-textarea\" name='config_fields[mtsn_CensorWords]'>" .
            $nuke_configs['mtsn_CensorWords'] .
            "</textarea>
			" .
		...
		<tr>
			<th>" .
            _IGNORE_SOME_WORDS_IN_SEARCH .
            "</th>
			<td>
				<select name=\"config_fields[mtsn_search_skipwords][]\" class=\"styledselect-select tag-input\" multiple=\"multiple\" style=\"width:100%\">";
        $mtsn_search_skipwords =
            $nuke_configs['mtsn_search_skipwords'] != ''
                ? explode(",", $nuke_configs['mtsn_search_skipwords'])
                : [];
		...
		<tr><th>" .
            _CENSORREPLACE .
            "</th><td>
			<input type=\"text\" name='config_fields[mtsn_CensorReplace]' class=\"inp-form\" value=\"" .
            $nuke_configs['mtsn_CensorReplace'] .
            "\">
		</td></tr>
		<tr><th>" .
            _LOGIN_ATTEMPTS .
            "</th><td>
			<input type=\"text\" name='config_fields[mtsn_login_attempts]' class=\"inp-form\" value=\"" .
            $nuke_configs['mtsn_login_attempts'] .
            "\">
			" .
		...
		<tr><th>" .
            _LOGIN_ATTTEMPTS_EXPIRE .
            "</th><td>
			<input type=\"text\" name='config_fields[mtsn_login_attempts_time]' class=\"inp-form\" value=\"" .
            $nuke_configs['mtsn_login_attempts_time'] .
            "\">
			" .
		...
		<tr><th>" .
            _REFERRERS_EXPIRE .
            "</th><td>
			<input type=\"text\" name='config_fields[mtsn_requests_mintime]' class=\"inp-form\" value=\"" .
            $nuke_configs['mtsn_requests_mintime'] .
            "\">
			" .
		...
		<tr><th>" .
            _ANTIFLOOD_ALLOWED_PAGENAMUBERS .
            "</th><td>
			<input type=\"text\" name='config_fields[mtsn_requests_pages]' class=\"inp-form\" value=\"" .
            $nuke_configs['mtsn_requests_pages'] .
            "\">
			" .
		...
		<tr><th>" .
            _MAX_LOGIN_TIME .
            "</th><td>
			<input type=\"text\" name='config_fields[session_timeout]' class=\"inp-form\" value=\"" .
            $nuke_configs['session_timeout'] .
            "\">
			" .
		...
		<input type='submit' name='submit' class=\"form-submit\" value='" .
            _SEND .
            "'>
		...
		<tr>
		<th class=\"table-header-repeat line-left\" style=\"text-align:center;\"><a>" .
            _HOST .
            "</a></th>
		<th class=\"table-header-repeat line-left\" style=\"text-align:center;\"><a>" .
            _IP_ADDRESS .
            "</a></th>
		<th class=\"table-header-repeat line-left\" style=\"text-align:center;width:180px;\"><a>" .
            _DATE .
            "</a></th>
		<th class=\"table-header-repeat line-left\" style=\"text-align:center;\"><a>" .
            _ATTACK_TYPE .
            "</a></th>
		<th class=\"table-header-repeat line-left\" style=\"text-align:center;width:200px;\"><a>" .
            _ADD_TO_BANED_LIST .
            "</a></th>
        ...
        if ($db->count() > 0) {
            foreach ($result as $row) {
                ...
                $contents .=
                    ...
                    $admin_file .
                    ".php?op=ip_ban_page&ipaddress=$ip'title=\"" .
                    _IP_BANNING .
                    "\" class=\"table-icon icon-1 info-tooltip\"></td>
				</tr>";
            }
        }
    ...
    function ip_ban_page($id = 0, $ipsearch = [], $ipsearch2, $ipaddress = '')
    {
        global $db, $admin_file, $hooks, $nuke_configs;
        ...
        if ($id != 0) {
            $ipaddress = isset($nuke_mtsn_ipban_cacheData[$id])
                ? $nuke_mtsn_ipban_cacheData[$id]['ipaddress']
                : '';
            $reason = isset($nuke_mtsn_ipban_cacheData[$id])
                ? $nuke_mtsn_ipban_cacheData[$id]['reason']
                : '';
            $status = isset($nuke_mtsn_ipban_cacheData[$id])
                ? $nuke_mtsn_ipban_cacheData[$id]['status']
                : 0;
            $expire = isset($nuke_mtsn_ipban_cacheData[$id])
                ? $nuke_mtsn_ipban_cacheData[$id]['expire']
                : 0;
            $expire =
                $expire != 0 ? nuketimes($expire, false, false, false, 1) : 0;
            $pagetitle .=
                " - " . _EDIT_IP . " : <span dir=\"ltr\">$ipaddress</span>";
        }
        $hooks->add_filter("set_page_title", function () use ($pagetitle) {
            return ["ip_ban_page" => $pagetitle];
        });
            ...
            "</th>
				<td>
					<select name=\"status\" class=\"styledselect-select\">
						<option value=\"1\" $status_sel1>" .
            _ALLOWED .
            "</option>
						<option value=\"0\" $status_sel2>" .
            _DISALLOWED .
            "</option>
					</select>
				</td>
		...
		<input type='hidden' name='op' value='addnewip'><input type='hidden' name='edited_id' value='$id'><input type=\"hidden\" name=\"csrf_token\" value=\"" .
            _PN_CSRF_TOKEN .
            "\" /> </form></div>
        ...
        if (!empty($nuke_mtsn_ipban_cacheData)) {
            $ipsearch_parts =
                isset($ipsearch) && !empty($ipsearch) ? $ipsearch : '';
            $contents .= "<br>";
            $contents .= OpenAdminTable();
            $contents .=
                "
			...
			<tr>
				<td colspan=\"5\">
					<form action=\"" .
                $admin_file .
                ".php?op=ip_ban_page\" method=\"post\">
						<b>" .
                _IP_SEARCH .
                " :</b> 
			...
			<tr>
                ...
                _IP .
                "</th>
				<th class=\"table-header-repeat line-left\" style=\"width:150px\">" .
                _IP_BANNER .
                "</th>
				<th class=\"table-header-repeat line-left\" style=\"width:80px\">" .
                _STATUS .
                "</th>
				<th class=\"table-header-repeat line-left\" style=\"width:300px\">" .
                _REASON .
                "</th>
				<th class=\"table-header-repeat line-left\" style=\"width:180px\">تاریخ</th>
				<th class=\"table-header-repeat no-padding\" style=\"width:120px\"><input type=\"checkbox\" data-label=\"" .
                _OPERATION .
                "\" class=\"styled select-all\" data-element=\"#baned-ips\"></th>
			</tr>";
            $nuke_mtsn_ipban_cacheData = array_reverse(
                $nuke_mtsn_ipban_cacheData,
                true
            );
            ...
            $link_to =
                ...
                $admin_file .
                ".php?op=ip_ban_page" .
                (isset($ipsearch) && !empty($ipsearch)
                    ? "&ipsearch2=" . base64_encode($ipsearch) . ""
                    : "");

            $nuke_mtsn_ipban_cacheData = array_slice(
                $nuke_mtsn_ipban_cacheData,
                $start_at,
                $entries_per_page,
                true
            ...
            foreach (
                $nuke_mtsn_ipban_cacheData
                as $id => $nuke_banned_ip_info
            ) {
                if (isset($ipsearch) && !empty($ipsearch)) {
                    if (
                        !stristr($nuke_banned_ip_info['ipaddress'], $ipsearch)
                    ) {
                        continue;
                    }
                }

                $nuke_banned_ip_info['reason'] = filter(
                    $nuke_banned_ip_info['reason'],
                    "nohtml"
                );
                $nuke_banned_ip_info['blocker'] = filter(
                    $nuke_banned_ip_info['blocker'],
                    "nohtml"
                );
                $nuke_banned_ip_info['status'] =
                    $nuke_banned_ip_info['status'] == 0
                        ? _DISALLOWED
                        : _ALLOWED;
                $contents .=
                    "<tr>
					<td align='center' dir=\"ltr\">&nbsp;" .
                    $nuke_banned_ip_info['ipaddress'] .
                    "</td>
					...
					<td align='center'>
						<a href=\"" .
                    $admin_file .
                    ".php?op=ip_ban_page&id=$id\" class=\"table-icon icon-1 info-tooltip\" title=\"" .
                    _EDIT .
                    "\"></a>
						<a href=\"" .
                    $admin_file .
                    ".php?op=deleteip&id=$id&csrf_token=" .
                    _PN_CSRF_TOKEN .
                    "\" class=\"table-icon icon-5 info-tooltip\" title=\"" .
                    _UNBAN .
    ...
    function addnewip($ipaddress, $reason, $status, $expire, $edited_id)
    {
        ...
        $ipaddress_check = adv_filter($ipaddress, [], ['required', 'valid_ip']);

        $validation = $ipaddress_check[0];
        $ipaddress = $ipaddress_check[1];
        if ($validation == 'error') {
            $contents .=
                "<div class=\"text-center\">$ipaddress" . _GOBACK . "</div>";
        } elseif ($ipaddress == '') {
            $contents .=
                "<div class=\"text-center\">" .
                _IPMUSTHAVEVALUE .
            ...
            $contents .=
                "<br><div class=\"text-center\"><a href = '$admin_file.php?op=ip_ban_page'>" .
                _GOBACK_TEXT .
                "</a></div>";
        } else {
            ...
            if ($edited_id > 0) {
                ...
                $time = _NOWTIME;
                $db->table(MTSN_IPBAN_TABLE)->insert([
                    'blocker' => $blocker,
                    'ipaddress' => $ipaddress,
                    'reason' => $reason,
                    'time' => $time,
    ...
    $baned_ip_list = isset($baned_ip_list) ? $baned_ip_list : [];
