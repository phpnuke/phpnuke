...
if (check_admin_permission($filename)) {
    function seo()
    {
		...
		<ul>
            ...
            _MAIN_SETTINGS .
            "</span></a></li>
			<li><a href=\"#engines\"><span>" .
            _SEARCH_ENGINS .
            "</span></a></li>
			<li><a href=\"#analytics\"><span>" .
            _GOOGLE_ANALYTICS .
            "</span></a></li>
			<li><a href=\"#feeds\"><span>" .
            _WEBSITE_FEEDS .
            "</span></a></li>
			<li><a href=\"#pings\"><span>" .
            _PING_SETTINGS .
            "</span></a></li>
		</ul>";
        ...
        $contents .=
            "<input data-label=\"" .
            _YES .
            "\" type=\"radio\" class=\"styled\" name=\"config_fields[gtset]\" value=\"1\" $check1> &nbsp; <input data-label=\"" .
            _NO .
            "\" type=\"radio\" class=\"styled\" name=\"config_fields[gtset]\" value=\"2\" $check2>";
		...
		<tr><th>" .
            _BRIEF_SITEDECRIPTION .
            "</th><td>
		<textarea class=\"form-textarea\" name='config_fields[site_description]' cols='70' rows='4' placeholder=\"" .
            _BRIEF_SITEDECRIPTION_PH .
            "\">$site_description</textarea>
		</td></tr>
		<tr><th>" .
            _METATAGS .
            "</th><td>
		<textarea class=\"form-textarea dleft\" name='config_fields[site_meta_tags]' cols='70' rows='4' placeholder=\"" .
            _METATAGS .
            "\">$site_meta_tags</textarea>
		" .
		...
		<table width=\"100%\">
			<tr>
				<td width=\"200\"><input data-label=\"" .
            _NAMEANDDAY .
            "\" type=\"radio\" class=\"styled\" name=\"config_fields[userurl]\" value=\"1\" $sel1></td>
				<td>" .
            bubble_show(
			...
			<tr>
				<td width=\"200\"><input data-label=\"" .
            _NAMEANDMONTH .
            "\" type=\"radio\" class=\"styled\" name=\"config_fields[userurl]\" value=\"2\" $sel2></td>
				<td>" .
            bubble_show(
                "<div style=\"direction:ltr;\">" .
                    $nukeurl .
			...
			<tr>
				<td width=\"200\"><input data-label=\"" .
            _NAMEANDSID .
            "\" type=\"radio\" class=\"styled\" name=\"config_fields[userurl]\" value=\"3\" $sel3></td>
				<td>" .
            bubble_show(
                "<div style=\"direction:ltr;\">" .
                    $nukeurl .
			...
			<tr>
				<td width=\"200\"><input data-label=\"" .
            _NAMEONLY .
            "\" type=\"radio\" class=\"styled\" name=\"config_fields[userurl]\" value=\"4\" $sel4></td>
				<td>" .
            bubble_show(
                "<div style=\"direction:ltr;\">" .
                    $nukeurl .
			...
			<tr>
				<td width=\"200\"><input data-label=\"" .
            _NAMEANDCATEGORY .
            "\" type=\"radio\" class=\"styled\" name=\"config_fields[userurl]\" value=\"5\" $sel5></td>
				<td>" .
            bubble_show(
                "<div style=\"direction:ltr;\">" .
                    $nukeurl .
        ...
        $contents .=
            "<input data-label=\"" .
            _YES .
            "\" type=\"radio\" class=\"styled\" name=\"config_fields[breadcrumb_cat]\" value=\"1\" $check1> &nbsp; <input data-label=\"" .
            _NO .
            "\" type=\"radio\" class=\"styled\" name=\"config_fields[breadcrumb_cat]\" value=\"0\" $check2>
			</td>
		</tr>";

        $contents .=
            "<input type='hidden' name='op' value='saveseo'><input type=\"hidden\" name=\"csrf_token\" value=\"" .
            _PN_CSRF_TOKEN .
            "\" /> " .
            "<tr><td></td><td><input class=\"form-submit\" type='submit' value='" .
            _SAVECHANGES .
            "'></form></td></tr></table>";
        $contents .= "</div>";
        ...
        $contents .=
            ...
            _GOOGLE_VERIFYCODE .
            " </th><td>
		<input type='text' class=\"inp-form\" name='config_fields[gverify]' value='$gverify' size='40' maxlength='255' placeholder=\"" .
            _YOUR_CODE .
            "\">
		" .
        ...
        $contents .=
            ...
            _ALEXA_VERIFYCODE .
            " </th><td>
		<input type='text' class=\"inp-form\" name='config_fields[alexverify]' value='$alexverify' size='40' maxlength='255' placeholder=\"" .
            _YOUR_CODE .
            "\">
		" .
        ...
        $contents .=
            ...
            _YAHOO_VERIFYCODE .
            "</th><td>
		<input type='text' class=\"inp-form\" name='config_fields[yverify]' value='$yverify' size='40' maxlength='255' placeholder=\"" .
            _YOUR_CODE .
            "\">
		" .
        ...
        $contents .=
            "<tr><th>" .
            _GOOGLE_ANALYTICSCODE .
            "</th><td>
		<input type='text' class=\"inp-form\" name='config_fields[ganalytic]' value='$ganalytic' size='40' maxlength='255' placeholder=\"" .
            _YOUR_CODE .
            "\">
		" .
        ...
        $contents .=
            ...
            _GOOGLESEARCHCODE .
            "</th><td>
		<input type='text' class=\"inp-form\" name='config_fields[gcse]' value='$gcse' size='40' maxlength='255' placeholder=\"" .
            _YOUR_CODE .
            "\">
		" .
            ...
            "<tr><td><input type='hidden' name='op' value='savesets'><input type=\"hidden\" name=\"csrf_token\" value=\"" .
            _PN_CSRF_TOKEN .
        ...
        foreach ($nuke_categories_cacheData as $module_name => $cat_data) {
            ...
            foreach ($cat_data as $catid => $catdata) {
                    ...
                    filter(
                        implode(
                            ...
                            array_reverse(
                                get_parent_names(
                                    $catid,
                                    $nuke_categories_cacheData[$module_name],
                                    "parent_id",
                                    "catname_url"
                                )
                            )
                ...
                $contents .=
                    "<tr>
					<td>
						<input class=\"inp-form dleft\" type=\"text\" name=\"feeds\" value=\"" .
                    $catlink .
                    "\" style=\"width:400px;\" readonly />
						" .
                    bubble_show(
                        "<a target=\"_blank\" href=\"$catlink\">$cattext</a>"
                    ) .
                    "
				</td></tr>";
            }
        ...
        $nuke_configs['ping_options'] =
            isset($nuke_configs['ping_options']) &&
            $nuke_configs['ping_options'] != ''
                ? unserialize($nuke_configs['ping_options'])
                : ["limit_ping" => 0, "limit_number" => 1, "limit_time" => 15];
        $limit_ping_chk =
            $nuke_configs['ping_options']['limit_ping'] == 1 ? "checked" : "";
        ...
        $contents .=
            ...
            _SITES_LINK .
            "</th><td>
		<textarea class=\"form-textarea dleft\" name='config_fields[ping_sites]' cols='70' rows='8' placeholder=\"" .
            _SITES_LINK .
            "\">$ping_sites</textarea>
		" .
        ...
        $contents .=
            "<tr><th style=\"width:200px\">" . _ACTIVATE_PING . "</th><td>";
        $check1 = $active_pings == 1 ? "checked" : "";
        $check2 = $active_pings == 0 ? "checked" : "";
        $contents .=
            "<input type=\"radio\" data-label=\"" .
            _YES .
            "\" class=\"styled\" name=\"config_fields[active_pings]\" value=\"1\" $check1> &nbsp; 
		<input data-label=\"" .
            _NO .
            "\" type=\"radio\" class=\"styled\" name=\"config_fields[active_pings]\" value=\"0\" $check2>";
		...
		" .
            sprintf(
                _PING_PER_TIME,
                "<input type='number' min=\"1\" max=\"10\" class=\"inp-form\" name='config_fields[ping_options][limit_number]' value='" .
                    $nuke_configs['ping_options']['limit_number'] .
                    "' size='10'>",
                "<input type='number' min=\"1\" class=\"inp-form\" name='config_fields[ping_options][limit_time]' value='" .
                    $nuke_configs['ping_options']['limit_time'] .
                    "' size='5'>"
            ) .
            "
		" .
            bubble_show(
                "<div style=\"margin-top:-7px;\"><span style=\"float:" .
                    _TEXTALIGN1 .
                    ";margin-top:7px\">" .
                    _PUBLISH_AT_FUTURE .
                    "</span> <input data-label=\"" .
                    _YES .
                    "\" type=\"checkbox\" class=\"styled\" name=\"config_fields[ping_options][limit_ping]\" value=\"1\" $limit_ping_chk /></div>"
            ) .
            "
		</td></tr>";

        $contents .=
            "<tr><td><input type='hidden' name='op' value='savepings'><input type=\"hidden\" name=\"csrf_token\" value=\"" .
            _PN_CSRF_TOKEN .
            "\" /> <input class=\"form-submit\" type='submit' value='" .
            _SAVECHANGES .
            "'>
    ...
    function saveseo($config_fields)
    {
        ...
        if (
            isset($config_fields['site_keywords']) &&
            !empty($config_fields['site_keywords'])
        ) {
		...
		END
		WHERE config_name IN('gtset', 'userurl', 'breadcrumb_cat', 'site_description', 'site_keywords', 'site_meta_tags')",
            [
                $gtset,
                $userurl,
                $breadcrumb_cat,
    ...
    function savepings($config_fields)
    {
        ...
        $ping_options =
            is_array($config_fields['ping_options']) &&
            !empty($config_fields['ping_options'])
                ? $config_fields['ping_options']
                : ["limit_ping" => 0, "limit_number" => 1, "limit_time" => 15];

        $ping_options['limit_ping'] =
            isset($config_fields['ping_options']['limit_ping']) &&
            $config_fields['ping_options']['limit_ping'] == 1
                ? 1
                : 0;
		...
		END
		WHERE config_name IN('ping_sites', 'active_pings', 'ping_options')",
            [$ping_sites, $active_pings, $ping_options]
        );
    ...
    function savesets($config_fields)
    {
		...
		END
		WHERE config_name IN('gverify', 'alexverify', 'yverify', 'ganalytic', 'gcse')",
            [$gverify, $alexverify, $yverify, $ganalytic, $gcse]
        );
