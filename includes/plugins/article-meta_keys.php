...
$nuke_meta_keys_parts['Articles'] = array(
	"is_album" => array(
		'label'	=> 'is album ?',
		'opts'	=>	array(
						'wrap_tag'  => '',
						'before_html'  => '<tr><th>ÂáÈæã</th><td>',
						'after_html'  => '</td></tr>',
						'id'  => 'is_album',
	...
	"send_to_top" => array(
		...
		'opts'	=>	array(
						'wrap_tag'  => '',
						'before_html'  => '<tr><th>ÇÑÓÇá Èå ÈÇáÇ</th><td>',
						'after_html'  => '</td></tr>',
						'id'  => 'send_to_top',
