...
$all_meta_tags['time'] =
    isset($all_meta_tags['time']) && $all_meta_tags['time'] != ''
        ? $all_meta_tags['time']
        : (isset($block_global_contents['time']) &&
        $block_global_contents['time'] != ''
            ? $block_global_contents['time']
            : _NOWTIME);

$all_meta_tags['title'] =
    $nuke_configs['sitename'] .
    (!defined("HOME_FILE")
        ? " - " .
            (isset($all_meta_tags['title'])
                ? strip_tags($all_meta_tags['title'])
                : '')
        : "");

$all_meta_tags['description'] = str_replace(
    ["\n", "\r"],
    "",
    isset($all_meta_tags['description']) && $all_meta_tags['description'] != ''
        ? stripslashes(strip_tags($all_meta_tags['description']))
        : stripslashes($nuke_configs['site_description'])
);

$all_meta_tags['keywords'] =
    isset($all_meta_tags['keywords']) && $all_meta_tags['keywords'] != ''
        ? $all_meta_tags['keywords']
        : $nuke_configs['site_keywords'];

$extra_all_meta_tags =
    isset($all_meta_tags['extra_all_meta_tags']) &&
    !empty($all_meta_tags['extra_all_meta_tags'])
        ? $all_meta_tags['extra_all_meta_tags']
        : [];

$all_meta_tags['url'] =
    isset($all_meta_tags['url']) && $all_meta_tags['url'] != ''
        ? $all_meta_tags['url']
        : "";
...
if ($all_meta_tags['description'] != '') {
    $meta_contents['description'] =
        "<meta name=\"description\" content=\"" .
        $all_meta_tags['description'] .
        "\">";
}

if ($all_meta_tags['url'] != '') {
    $meta_contents['canonical'] =
        "<link rel=\"canonical\" href=\"" . $all_meta_tags['url'] . "\" />";
}

if (isset($all_meta_tags['prev']) && $all_meta_tags['prev'] != '') {
    $meta_contents['prev'] =
        "<link rel=\"prev\" href=\"" . $all_meta_tags['prev'] . "\" />";
}

if (isset($all_meta_tags['next']) && $all_meta_tags['next'] != '') {
    $meta_contents['next'] =
        "<link rel=\"next\" href=\"" . $all_meta_tags['next'] . "\" />";
}

// Open Graph protocol
$theme_get_media_function = '';
$theme_get_media_function = $hooks->apply_filters(
...
if (function_exists($theme_get_media_function)) {
    ...
    if ($all_meta_tags['meta_image'] != '') {
        $meta_image = LinkToGT(
            "index.php?timthumb=true&src=" .
                $all_meta_tags['meta_image'] .
                "&q=90&w=400&h=400"
        );
        $meta_contents['og:image'] =
            "<meta property=\"og:image\" content=\"" . $meta_image . "\" />";
        $meta_contents['og:image:secure_url'] =
            "<meta property=\"og:image:secure_url\" content=\"" .
            $meta_image .
            "\" />";
        $meta_contents['og:image:type'] =
            "<meta property=\"og:image:type\" content=\"image/jpeg\" />";
        $meta_contents['og:image:width'] =
            "<meta property=\"og:image:width\" content=\"400\" />";
        $meta_contents['og:image:height'] =
            "<meta property=\"og:image:height\" content=\"400\" />";
        $meta_contents['og:image:alt'] =
    ...
    if ($all_meta_tags['meta_audio'] != '') {
        $meta_contents['og:audio'] =
            "<meta property=\"og:audio\" content=\"" .
            $all_meta_tags['meta_audio'] .
            "\" />";
        $meta_contents['og:audio:secure_url'] =
            "<meta property=\"og:audio:secure_url\" content=\"" .
            $all_meta_tags['meta_audio'] .
            "\" />";
        $meta_contents['og:audio:type'] =
            "<meta property=\"og:audio:type\" content=\"audio/mpeg\" />";
    }

    if ($all_meta_tags['meta_video'] != '') {
        $meta_contents['og:video'] =
            "<meta property=\"og:video\" content=\"" .
            $all_meta_tags['meta_video'] .
            "\" />";
        $meta_contents['og:video:secure_url'] =
            "<meta property=\"og:video:secure_url\" content=\"" .
            $all_meta_tags['meta_video'] .
            "\" />";
        $meta_contents['og:video:type'] =
            "<meta property=\"og:video:type\" content=\"video/mp4\" />";
        $meta_contents['og:video:width'] =
            "<meta property=\"og:video:width\" content=\"400\" />";
        $meta_contents['og:video:height'] =
            "<meta property=\"og:video:height\" content=\"300\" />";
    }
}

$meta_contents['og:site_name'] =
    "<meta property=\"og:site_name\" content=\"" .
    $nuke_configs['sitename'] .
    "\" />";
$meta_contents['og:title'] =
    "<meta property=\"og:title\" content=\"" .
    $all_meta_tags['title'] .
    "\" />";
$meta_contents['og:description'] =
    "<meta property=\"og:description\" content=\"" .
    $all_meta_tags['description'] .
    "\" />";
$meta_contents['og:locale'] =
...
if ($modname == "Articles" && $op == "article_show") {
    $meta_contents['article:published_time'] =
        "<meta property=\"article:published_time\" content=\"" .
        date('Y-m-d\TH:i:s+00:00', $all_meta_tags['time']) .
        "\" />";
    $meta_contents['article:modified_time'] =
        "<meta property=\"article:modified_time\" content=\"" .
        date('Y-m-d\TH:i:s+00:00', $all_meta_tags['time']) .
        "\" />";

    if (
        isset($block_global_contents['aid']) &&
        $block_global_contents['aid'] != ''
    ) {
        $meta_contents['article:author'] =
...
if (
    isset($nuke_configs['site_meta_tags']) &&
    $nuke_configs['site_meta_tags'] != ''
) {
    $nuke_configs['site_meta_tags'] = stripslashes(
        $nuke_configs['site_meta_tags']
    );
    ...
    $meta_contents['site_meta_tags'] = stripslashes(
        $nuke_configs['site_meta_tags']
    );
}
// site meta tags settings
...
if (
    $nuke_configs['gverify'] != "" . _YOUR_CODE . "" &&
    $nuke_configs['gverify'] != ""
) {
    $meta_contents['gverify'] =
...
if (
    $nuke_configs['alexverify'] != "" . _YOUR_CODE . "" &&
    $nuke_configs['alexverify'] != ""
) {
    $meta_contents['alexverify'] =
...
if (
    $nuke_configs['yverify'] != "" . _YOUR_CODE . "" &&
    $nuke_configs['yverify'] != ""
) {
    $meta_contents['yverify'] =
        "<meta name=\"y_key\" content=\"" . $nuke_configs['yverify'] . "\">";
}
...
$meta_contents[
    'Atom'
] = "<link rel=\"alternate\" type=\"application/atom+xml\" title=\"Atom\" href=\"$rsslink\" />";
// rss codes

//$extra_meta_tags
if (
    isset($all_meta_tags['extra_meta_tags']) &&
    !empty($all_meta_tags['extra_meta_tags'])
) {
    $meta_contents = array_merge_recursive(
        $meta_contents,
        $all_meta_tags['extra_meta_tags']
    );
}
//$extra_meta_tags
...
$meta_contents['default_meta'] = $meta_contents[
    'default_link_rel'
] = $meta_contents['default_css'] = $meta_contents['default_js'] = '';
if (
    isset($theme_setup['default_meta']) &&
    !empty($theme_setup['default_meta'])
) {
    foreach ($theme_setup['default_meta'] as $key => $default_meta) {
        if ($default_meta != '') {
            $meta_contents['default_meta'] .=
                ($key != 0 ? "\n\t\t" : "") . "" . $default_meta;
        }
    };
}
...
if (
    isset($theme_setup['default_link_rel']) &&
    !empty($theme_setup['default_link_rel'])
) {
    foreach ($theme_setup['default_link_rel'] as $key => $default_link_rel) {
        if ($default_link_rel != '') {
            $meta_contents['default_link_rel'] .=
                ($key != 0 ? "\n\t\t" : "") . "" . $default_link_rel;
        }
    };
}
...
if (!defined("_ERROR_PAGE")) {
    $meta_contents['microdata'] = show_microdata_as_json(
        $all_meta_tags,
        $block_global_contents
    );
}
...
function show_microdata_as_json(&$meta_tags, $block_global_contents)
{
    ...
    $nuke_categories_cacheData = isset($nuke_categories_cacheData[$main_module])
        ? $nuke_categories_cacheData[$main_module]
        : [];

    $now = date('Y-m-d\TH:i:s+00:00', $meta_tags['time']);

    $custom_microdata =
        isset($meta_tags['microdata']) && $meta_tags['microdata'] != ''
            ? $meta_tags['microdata']
            : "";
    ...
    foreach ($nuke_authors_cacheData as $aid => $nuke_authors) {
        ...
        $json_ld->$graph_key[] = (object) [
            ...
            "@id" =>
                $nuke_configs['nukeurl'] . "#/schema/person/" . md5($aid) . "",
            "name" => "$aid",
            "url" => $nuke_configs['nukeurl'],
            "image" => (object) [
                "@type" => "ImageObject",
                "@id" =>
                    $nuke_configs['nukeurl'] . "#personlogo_" . md5($aid) . "",
    ...
    $json_ld->$graph_key['WebSite'] = (object) [
        ...
        "publisher" => (object) [
            "@id" =>
                $nuke_configs['nukeurl'] . "#/schema/person/" . md5($God) . "",
        ],
        "potentialAction" => [
            (object) [
                "@type" => "SearchAction",
                "target" => str_replace(
                    ...
                    ["{", "}"],
                    LinkToGT(
                        "index.php?modname=Search&search_query={search_term_string}"
                    )
                ),
    ...
    $breadcrumbs = $hooks->apply_filters(
        "site_breadcrumb",
        $breadcrumbs,
        $block_global_contents
    );
    ...
    return "<script type=\"application/ld+json\">" .
        json_encode($json_ld, JSON_UNESCAPED_SLASHES) .
        "</script>";
}
