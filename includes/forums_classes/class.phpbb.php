...
class users_system{
	...
	public function __construct()
	{
		...
		$this->login_url				= $this->forum_url.(($nuke_configs['gtset'] == 1 && $nuke_configs['forum_GTlink_active'] == 1 && isset($nuke_configs['forum_seo_register_link']) && $nuke_configs['forum_seo_register_link'] != '') ? str_replace(array("{UID}","{UN}"),array('%1$d','%2$s'), $nuke_configs['forum_seo_register_link']):'ucp.php?mode=login');
