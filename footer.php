...
function footmsg()
{
    ...
    $total_time =
        _PAGEGENERATION . " " . substr($total_time, 0, 4) . " " . _SECOND;
...
function foot()
{
    ...
    if (
        ...
        defined('MODULE_FILE') and
        file_exists("modules/$modname/copyright.php") &&
    ...
    if (
        basename($_SERVER['PHP_SELF']) != "index.php" and
        defined('MODULE_FILE') and
        file_exists("modules/$modname/admin/panel.php") && is_admin()
    ) {
        $html_output .= "<br>";
    ...
    if (
        ...
        $nuke_configs['website_index_theme'] == 0 ||
