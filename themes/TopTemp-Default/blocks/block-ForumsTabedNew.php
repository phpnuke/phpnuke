...
function toptemp_MTForumBlock_assets($theme_setup)
{
	global $nuke_configs;
...
$hooks->add_filter("site_theme_headers", "toptemp_MTForumBlock_assets", 10);

$content .= "
<div id=\"forum_tabs\" style=\"display:none;\" class=\"MTForumBlock font-weight-bold text-heading-default widget-title2\">
    <ul>
